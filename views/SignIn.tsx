...
export default function SignIn() {
  ...
  async function signIn() {
    ...
    try { sessionStorage.setItem('er_auth_return', returnTo); } catch { /* Sign-in still works without navigation persistence. */ }
    try {
  ...
  return <div className="min-h-[calc(100svh-80px)] flex items-center justify-center px-5 py-10"><div className="w-full max-w-md text-center space-y-6">
