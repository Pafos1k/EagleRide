  ...
  const handleCreateRide = async () => {
    ...
    try {
      const ride = await createRide({
        ...
        departureMode: selectedTime === 'Now' && selectedDate.toDateString() === new Date().toDateString() ? 'now' : 'scheduled',
    ...
    <div className="w-full bg-white" ref={containerRef}>
      ...
      >
        <div className="w-full max-w-[1040px] flex flex-col items-center">
          <h1 className="text-[44px] sm:text-5xl lg:text-[64px] font-bold leading-[1.1] mb-8 sm:mb-10 lg:mb-10 tracking-tight text-black text-center">Plan a ride</h1>
